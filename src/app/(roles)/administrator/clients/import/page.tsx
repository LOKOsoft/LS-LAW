...
export default async function AdministratorImportClientsPage() {
  ...
  return (
    <div>
      ...
      <ImportClientsView managers={managers} currentUserId={currentUser.id} basePath={ADMINISTRATOR_BASE} />
    </div>
  );
}
