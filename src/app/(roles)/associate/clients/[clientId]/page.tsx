...
export default async function AssociateClientDetailPage({ params }: { params: Promise<{ clientId: string }> }) {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <ClientDetailTabs client={client} currentUserId={user.id} basePath={ASSOCIATE_BASE} />
    </div>
  );
}
