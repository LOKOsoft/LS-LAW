...
export default async function ParalegalMatterDetailPage({ params }: { params: Promise<{ matterId: string }> }) {
  ...
  return (
    <div className="space-y-6 pb-8">
      <MatterHeader matter={matter} basePath={PARALEGAL_BASE} currentUserId={user.id} />
