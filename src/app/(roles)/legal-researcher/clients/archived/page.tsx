...
export default async function LegalResearcherArchivedClientsPage() {
  ...
  return (
    <div>
      ...
      <ArchivedClientsTable clients={clients} currentUserId={currentUser.id} basePath={LEGAL_RESEARCHER_BASE} canRestore={true} />
    </div>
  );
}
