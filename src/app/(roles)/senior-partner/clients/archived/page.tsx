...
export default async function SeniorPartnerArchivedClientsPage() {
  ...
  return (
    <div>
      ...
      <ArchivedClientsTable clients={clients} currentUserId={currentUser.id} basePath={SENIOR_PARTNER_BASE} canRestore={true} />
    </div>
  );
}
